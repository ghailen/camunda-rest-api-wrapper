...
[BPMN Process](src/main/resources/student-manipulation.bpmn)
...
```bash
java -jar target/camunda-rest-call-manipulation.jar
```
...
<!-- Tweet
New @Camunda example: Camunda Spring Boot Application - Spring Boot Application using [Camunda](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/camunda-rest-call-manipulation
-->
